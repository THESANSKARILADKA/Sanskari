"""AFK Plugin for SANSKARI USERBOT
Syntax: .afk REASON"""
import asyncio
import datetime
...
async def on_afk(event):
    ...
    if USER_AFK and not (await event.get_sender()).bot:  # pylint:disable=E0602
        ...
        msg = None
        message_to_reply = f"ᗰᖇᏀᗴᗩ ᕼ ᗰᗴᖇᗩ ᗰᗩᔑᎢᗴᖇ {afk_since}\nWhere He Is: **𝙰𝙱𝙷𝙸 𝚄𝚂𝙴 𝚈𝙰𝙰𝙳 𝙺𝚁𝙽𝙴 𝙺𝙰 𝙺𝙾𝙸 𝙵𝚈𝙰𝙳𝙰 𝙽𝙷𝙸🤣🤣𝙸𝚂𝙻𝙸𝚈𝙴 𝙲𝙷𝚄𝙿 𝙷𝙾 𝙹𝙰𝙾𝙾..!                          𝐑𝐄𝐀𝐒𝐎𝐍 𝐆𝐈𝐕𝐄𝐍 𝐁𝐄𝐋𝐎𝐖, 𝐈𝐅 𝐍𝐎𝐓 𝐓𝐇𝐄𝐍 𝐈𝐓𝐒 𝐍𝐎𝐍𝐄 𝐎𝐅 𝐌𝐘 𝐁𝐔𝐒𝐒𝐈𝐍𝐄𝐒𝐒 𝐓𝐎 𝐈𝐍𝐓𝐄𝐑𝐅𝐀𝐈𝐑 𝐈𝐍 𝐌𝐘 𝐌𝐀𝐒𝐓𝐄𝐑'𝐒 𝐖𝐎𝐑𝐊 𝐒𝐎 𝐁𝐄𝐓𝐓𝐄𝐑 𝐖𝐀𝐈𝐓 𝐅𝐎𝐑 𝐒𝐎𝐌𝐄𝐓𝐈𝐌𝐄 𝐓𝐈𝐋𝐋 𝐇𝐄 𝐂𝐎𝐌𝐄𝐒❤** " + \
