"""@telegraph Utilities Fix by @thesanskari_ladka
Available Commands:
    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "media":
            ...
            try:
                ...
                os.remove(downloaded_file_name)
                await event.edit("File uploaded ser By 🄳 🄰 🅁 🄺  🄲 🄾 🄱 🅁 🄰 ᴛʜᴇ ʙᴇsᴛ ᴜsᴇʀʙᴏᴛ.. https://telegra.ph{} ".format(media_urls[0], (ms + ms_two)), link_preview=True)
        elif input_str == "text":
