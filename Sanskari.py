...
@borg.on(admin_cmd(pattern="selmun ?(.*)"))
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit("😁Sanskari Bhoi wants to go on a Ride😨")
        ...
        await event.edit("🚗🚗🚗\n🚘🚘🚘\n🚗🚗🚗\n🚘🚘🚘")
        await asyncio.sleep(1)
        await event.edit("🙁Sanskari Bhoi Iz feeling Hungry😖 \nAlso he iz big fan of Bear Grills🤫😬")
        ...
        await event.edit("🚗🚗🚗\n🚘🚘🚘\n🚗🚗🚗\n🚘🚘🚘")
        await asyncio.sleep(1)
        await event.edit("Sanskari Bhoi reached home🙂 \nAnd went to sleep😴🛌")
        await asyncio.sleep(3)
        await event.edit("Next Day \n2 Poor people \nWho used to sleep on foothpath \nWere reported ded⚰️🥀")
        await asyncio.sleep(4)
        await event.edit("Sanskari bhoi drove his car from that road last night🌃 \nRest is a mystery.......")
